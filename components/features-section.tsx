  ...
  return (
    <section id="features" className="py-32 px-6 relative overflow-hidden bg-background">
      ...
      <div className="max-w-7xl mx-auto relative z-10 text-center">
        <div className="inline-flex items-center gap-2 mb-10 px-4 py-1.5 rounded-full border border-foreground/10 bg-foreground/5 dark:bg-white/5">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 relative">
          ...
          {features.map((feature, idx) => (
            <div
              key={feature.title}
              className="relative text-left flex flex-col items-center group transition-all duration-300 md:items-start"
            >
              <div className="relative mb-8">
                ...
                <div className="absolute -top-6 -right-6 text-[48px] font-black text-foreground/5 select-none transition-all group-hover:text-foreground/10">
                  {idx + 1}
                </div>
              </div>
